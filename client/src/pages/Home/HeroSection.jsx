  ...
  return (
    ...
    {/* <section className={`section-hero ${theme == "light" ? "light" : "dark"}`}>
        <div className={`container hero-container ${theme == "dark" && "dark"}`}>
                    ...
                    <div className='hero-btn-container'><button className={`commonBtn ${theme == "light" ? "light" : "dark"} hero-btn`} onClick={handleContactForm}>Join the waiting list</button></div>
